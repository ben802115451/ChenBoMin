...
import com.digiwin.dwapiplatform.dwsysmanagement.service.IBannerService;
...
public class BannerService implements IBannerService {
    ...
    public Object deleteBlocks(List<Object> oids) throws Exception {
        ...
        DWDataSet dataset = builder.addTable("adbanner_block").setDeletedOids(oids).createDataSet();

        // 設定連動信息
        DWDataSetOperationOption option = new DWDataSetOperationOption();
        option.addCascadeDeleting("adbanner_block", "adbanner");
